...
Address in addresses configuration must be a valid address
    ${response} =  Run task    module/${module_id}/configure-module
    ...    {"addresses": {"address": "A"}}    rc_expected=10    decode_json=False

Public address in addresses configuration must be a valid address
    ${response} =  Run task    module/${module_id}/configure-module
    ...    {"addresses": {"public_address": "B"}}    rc_expected=10    decode_json=False
